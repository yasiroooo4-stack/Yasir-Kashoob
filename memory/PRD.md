...
- [x] جدول السائقين الشهري - تم إنشاء API وصفحة كاملة
...
### نقل الصفحات
- ✅ **جدول السائقين** → تبويب داخل صفحة جدولة الموظفين (/employee-scheduling)
- ✅ **صرف المواد** → تبويب داخل صفحة إدارة المخازن (/warehouse)

### حذف الروابط
- ✅ إزالة /driver-schedule من القائمة الجانبية
- ✅ إزالة /material-issue من القائمة الجانبية

### الصلاحيات
- ✅ تم حذف جميع الصلاحيات من جميع الموظفين
...
- ✅ صفحة صرف المواد: 5/5 ناجح (iteration_12)
- ✅ جدول السائقين والتنظيم: 100% ناجح (iteration_13)
