...
async def send_password_reset_email(email: str, token: str, full_name: str):
    ...
    reset_link = f"{os.environ.get('FRONTEND_URL', 'https://dairy-farm-erp-3.preview.emergentagent.com')}/reset-password?token={token}"
...
[API]
url = https://dairy-farm-erp-3.preview.emergentagent.com
username = 
password = 
